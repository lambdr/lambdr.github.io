...
Go to [the IRS website](https://www.irs.gov/payments/pay-personal-taxes-from-your-bank-account) and click on "Make a payment" under "Pay personal taxes".

1. The reason for payment is "Estimated Tax" which should be applied to your 1040ES. Select the appropriate tax period.

2. Verify your identity based upon a previous year's tax return.

3. Enter the payment amount and your bank info.
