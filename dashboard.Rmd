...
output: 
  flexdashboard::flex_dashboard:
    ...
    navbar:
      ...
      - { icon: "fa-envelope fa-lg", href: "mailto:<drl2168@cumc.columbia.edu>", align: right }
      - { icon: "fa-brands fa-linkedin", href: "https://www.linkedin.com/in/derek-lamb-b7bb86169/", align: right }
      - { icon: "fa-github fa-lg", href: "http://github.com/lambdr/", align: right }
---
...
df_ghcnd = read_csv("files/ghcnd-stations_NY.csv") |> 
  janitor::clean_names() |> 
  rename(city = info1) |> 
...
### Annual max temperature in four cities
...
-----------------------------------------------------------------------
### Comparing snowfall and total precipitation
...
### Snowfall distribution in four cities
